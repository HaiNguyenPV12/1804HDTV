        ...
        <div class="row mt-3">
            <div class="col-lg-3 col-md-5 mb-4">
                <div class="card h-80 border-primary border-shop">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="#">Hoa Hồng - Cảm Tạ</a>
                        </h4>
                        <h5>400.000 Đ</h5>
                        <p class="card-text">Bó Hoa Hồng đỏ đậm tình yêu thương và sự chân thành</p>
                    </div>
            ...
            <div class="col-lg-3 col-md-5 mb-4">
                <div class="card h-100 border-primary border-shop">
                    <a href="#"><img class="card-img-top custom" src="../img/Bouquet/B001/B001_PV.jpg" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="#">Hoa Hồng - Lãng mạn</a>
                        </h4>
                        <h5>550.000 Đ</h5>
                        <p class="card-text">Sắc hồng quyến rũ và lãng mạn</p>
                    </div>
                    <button class="btn card-footer btn-shop">
                        Xem chi tiết
                    </button>
            ...
            <div class="col-lg-3 col-md-5 mb-4">
                <div class="card h-100 border-primary border-shop">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="#">Hoa Hồng - Quý phái</a>
                        </h4>
                        <h5>550.000 Đ</h5>
                        <p class="card-text">Kết hợp giữa màu tím huyền bí và màu trắng lịch lãm, sang trọng</p>
                    </div>
                    <button class="btn card-footer btn-shop">
                        Xem chi tiết
                    </button>
            ...
            <div class="col-lg-3 col-md-5 mb-4">
                <div class="card h-100 border-primary border-shop">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="#">Hoa Hồng - Mạnh mẽ lên</a>
                        </h4>
                        <h5>440.000 Đ</h5>
                        <p class="card-text">Kết hợp hoa hướng dương cùng hoa hồng</p>
                    </div>
                    <button class="btn card-footer btn-shop">
                        Xem chi tiết
                    </button>
