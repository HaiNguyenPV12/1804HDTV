...
<script src="../Scripts/1804HDTVAdmin/bouquetedit2.js"></script>
<!-- Form -->
<form id="frmEditBouquet" name="frmEditBouquet" class="" method="post">
    ...
    <div class="form-inline">
        <label class="mb-2 mr-sm-2 col-2">Tên bó hoa:</label>
        <input type="text" readonly class="form-control mb-2 mr-sm-2 col-2" name="bid" id="bid" value="<?php echo $id?>"
            tabindex="-1">
    ...
    <!-- Giá -->
    <div class="form-inline">
        <label class="mb-2 mr-sm-2 col-2">Giá:</label>
    ...
    <div class="form-inline">
        ...
        <label class="mr-sm-2 mb-2">
            <input type="checkbox" class="form-check-input" name="bselling" id="bselling"
