<html>
    ...
    <div class='row'>
        ...
        <button type="button" class="btn btn-success btn-lg col-2 btn-shop" data-toggle="modal" data-target="#modal" ng-click="temp.url = 'staffadd.php';modalHText='Thêm nhân viên mới';">Thêm mới</button>
    </div>
