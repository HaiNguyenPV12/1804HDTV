...
$("#cmdAddRPosition").click(function(e){
    ...
    if (($("#right_list").html()).indexOf(rinsertID)!=-1) {
        ...
        $("#right_list").append(
            '<button name="right_item" class="list-group-item list-group-item-info d-flex justify-content-between align-items-center py-2">'+rinsertname+
...
var request;
//Nếu form submit
$('#frmEditRPosition').submit(function(event){
