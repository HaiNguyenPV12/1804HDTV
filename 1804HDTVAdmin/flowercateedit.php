...
<form id="frmEditFlowerCate" name="frmEditFlowerCate" class="" method="post">
    ...
    <div class="form-inline">
        ...
        <input type="text" autofocus required class="form-control mb-2 mr-sm-2 col-9" name="editfcateid" id="editfcateid" autocomplete="off" maxlength="2" value="<?php echo $data['f_cate_ID'] ?>">
    </div>
    <div class="form-inline">
